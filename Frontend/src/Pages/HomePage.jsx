...
<p className='text-sm [@media(min-width:460px)]:text-base'>NuxEland is the legendary land of the magical, mystic and undiscovered. It is as old as time itself. Veronica Verma was the first from Earth to venture to this perspiciatis ea laudantium a veniam esse nemo expedita similique nobis ut aspernatur earum, reiciendis eligendi reprehenderit distinctio iste numquam, itaque obcaecati.
