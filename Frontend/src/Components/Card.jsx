...
<div className={`body dark-background flex justify-center flex-col ${props.style} bg-no-repeat bg-center`} style={{backgroundSize:'140%!important'}}>
      <div className="outer-border border-2 h-[400px] w-[400px] border-solid border-[#DE9B72] bg-black mx-0 my-auto p-[6px]">
         <div className='mid-border w-full h-full border-[6px] m-auto border-[#DE9B72]'>
          <img className='absolute object-cover w-[372px] h-[372px]' src={props.imgUrl} alt="" />
