...
function Card(props) {
  return (
<div className="body dark-background flex justify-center flex-col h-[400px]  w-[300px] bg-no-repeat bg-center" style={{backgroundSize:'140%!important'}}>
      <div className="outer-border border-2 h-[99%] w-[98%] border-solid border-[#DE9B72] bg-black mx-0 my-auto p-[6px]">
         <div className={`mid-border w-full h-full border-[6px] m-auto border-[#DE9B72] bg-[url(${props.imgUrl})]`}>
